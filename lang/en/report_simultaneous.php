...
$string['adminlisttitle'] = 'Detailed events list';
$string['clearfilterresults'] = 'Clear filter';
$string['eventreportviewed'] = 'simultaneous usage report viewed';
$string['filterresults'] = 'Filter';
$string['filtertext'] = 'Filter text';
$string['force_activity_time'] = 'Force to refer an activity';
$string['force_activity_time_help'] = 'Force the teacher to specify an activity for the time window.If disabled allows teachers to specify a free time window.';
...
$string['indicators'] = 'Enabled indicators';
