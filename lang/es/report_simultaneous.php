...
$string['adminlisttitle'] = 'Listado detallado de eventos';
$string['clearfilterresults'] = 'Limpiar filtro';
$string['eventreportviewed'] = 'Informe de uso simultáneo visto';
$string['filterresults'] = 'Filtrar';
$string['filtertext'] = 'Texto de filtro';
