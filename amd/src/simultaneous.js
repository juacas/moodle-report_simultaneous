...
/**
 * Some UI stuff for simultaneous page.
 * This is also used by the report/simultaneous/index.php because it has the same functionality.
 *
 * @module     report/simultaneous
...
const Selectors = {
    ...
    bulkUserSelectedCheckBoxes: "input[data-togglegroup^='simultaneous-table'][data-toggle='slave']:checked",
    simultaneousForm: '#simultaneousreport',
};

export const init = () => {
    const root = document.querySelector(Selectors.simultaneousForm);
                ...
                if (action === '#messageselect') {
                    ...
                    .then(modal => {
                        modal.getRoot().on(ModalEvents.hidden, () => {
                            ...
                            const bulkActionSelector = document.querySelector(Selectors.bulkActionSelect);
